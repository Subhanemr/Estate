...
namespace Estate.MVC.Areas.Admin.Controllers
{
    ...
    public class FeaturesController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create(CreateFeaturesVM create, string? returnUrl)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Update(int id, string? returnUrl, UpdateFeaturesVM update)
        {

...
namespace Estate.MVC.Areas.Admin.Controllers
{
    ...
    public class ParkingTypeController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create(CreateParkingTypeVM create, string? returnUrl)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Update(int id, string? returnUrl, UpdateParkingTypeVM update)
        {

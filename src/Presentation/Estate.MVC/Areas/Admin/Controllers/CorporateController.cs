...
namespace Estate.MVC.Areas.Admin.Controllers
{
    ...
    public class CorporateController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create(CreateCorporateVM create, string? returnUrl)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Update(int id, string? returnUrl, UpdateCorporateVM update)
        {

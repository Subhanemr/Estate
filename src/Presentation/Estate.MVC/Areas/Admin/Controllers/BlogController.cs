...
namespace Estate.MVC.Areas.Admin.Controllers
{
    ...
    public class BlogController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create(CreateBlogVM create, string? returnUrl)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Update(int id, string? returnUrl, UpdateBlogVM update)
        {

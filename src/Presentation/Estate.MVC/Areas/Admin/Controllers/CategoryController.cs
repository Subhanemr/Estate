...
namespace Estate.MVC.Areas.Admin.Controllers
{
    ...
    public class CategoryController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create(CreateCategoryVM create, string? returnUrl)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Update(int id, string? returnUrl, UpdateCategoryVM update)
        {

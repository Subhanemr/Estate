...
namespace Estate.MVC.Areas.Admin.Controllers
{
    ...
    public class ViewTypeController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create(CreateViewTypeVM create, string? returnUrl)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Update(int id, string? returnUrl, UpdateViewTypeVM update)
        {

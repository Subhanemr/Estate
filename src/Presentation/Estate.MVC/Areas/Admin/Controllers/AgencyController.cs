...
namespace Estate.MVC.Areas.Admin.Controllers
{
    ...
    public class AgencyController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create(CreateAgencyVM create)
        {
        ...
        {
            UpdateAgencyVM item = await _service.UpdateAsync(id);

            return View(item);
        }
        [HttpPost]
        public async Task<IActionResult> Update(int id, UpdateAgencyVM update)
        {
        ...
        {
            GetAgencyVM get = await _service.GetByIdAsync(id);

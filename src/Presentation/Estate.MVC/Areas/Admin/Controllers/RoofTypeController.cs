...
namespace Estate.MVC.Areas.Admin.Controllers
{
    ...
    {
        private readonly IRoofTypeService _service;

        public RoofTypeController(IRoofTypeService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Create(CreateRoofTypeVM create)
        {
        ...
        {
            UpdateRoofTypeVM item = await _service.UpdateAsync(id);

            return View(item);
        }
        [HttpPost]
        public async Task<IActionResult> Update(int id, UpdateRoofTypeVM update)
        {
        ...
        {
            GetRoofTypeVM get = await _service.GetByIdAsync(id);

...
namespace Estate.MVC.Areas.Admin.Controllers
{
    ...
    public class RoofTypeController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create(CreateRoofTypeVM create, string? returnUrl)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Update(int id, string? returnUrl, UpdateRoofTypeVM update)
        {

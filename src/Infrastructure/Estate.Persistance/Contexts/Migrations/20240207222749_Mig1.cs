        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LinkedLink = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CorporateLink = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Img = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreateAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExteriorTypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Img = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PhoneSecond = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    SoulOfAgency = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Bedrooms = table.Column<byte>(type: "tinyint", nullable: false),
                    Bathrooms = table.Column<byte>(type: "tinyint", nullable: false),
                    Garages = table.Column<byte>(type: "tinyint", nullable: false),
                    ...
                    SchoolDistrictPhone = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    MiddleSchool = table.Column<bool>(type: "bit", nullable: false),
                    ElementarySchool = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlogReplies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BlogReplies_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BlogReplies_BlogComments_BlogCommentId",
            ...
            migrationBuilder.CreateTable(
                name: "ProductExteriorTypes",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    ExteriorTypeId = table.Column<int>(type: "int", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreateAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdateAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductExteriorTypes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductExteriorTypes_ExteriorTypes_ExteriorTypeId",
                        column: x => x.ExteriorTypeId,
                        principalTable: "ExteriorTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductExteriorTypes_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductParkingTypes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductParkingTypes_ParkingTypes_ParkingTypeId",
                        column: x => x.ParkingTypeId,
                        principalTable: "ParkingTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductParkingTypes_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "ProductRoofTypes",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    RoofTypeId = table.Column<int>(type: "int", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreateAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdateAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductRoofTypes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductRoofTypes_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductRoofTypes_RoofTypes_RoofTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductViewTypes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductViewTypes_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductViewTypes_ViewTypes_ViewTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductReplies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductReplies_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlogReplies_AppUserId",
                table: "BlogReplies",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_BlogReplies_BlogCommentId",
                table: "BlogReplies",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductExteriorTypes_ExteriorTypeId",
                table: "ProductExteriorTypes",
                column: "ExteriorTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductExteriorTypes_ProductId",
                table: "ProductExteriorTypes",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductParkingTypes_ParkingTypeId",
                table: "ProductParkingTypes",
                column: "ParkingTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductParkingTypes_ProductId",
                table: "ProductParkingTypes",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductReplies_AppUserId",
                table: "ProductReplies",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductReplies_ProductCommentId",
                table: "ProductReplies",
                column: "ProductCommentId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductRoofTypes_ProductId",
                table: "ProductRoofTypes",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductRoofTypes_RoofTypeId",
                table: "ProductRoofTypes",
                column: "RoofTypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductViewTypes_ProductId",
                table: "ProductViewTypes",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductViewTypes_ViewTypeId",
                table: "ProductViewTypes",
                column: "ViewTypeId");
        }

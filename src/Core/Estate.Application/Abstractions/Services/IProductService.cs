...
namespace Estate.Application.Abstractions.Services
{
    public interface IProductService
    {
        ...
        Task<bool> CreateAsync(CreateProductVM create, ModelStateDictionary model);
        Task<UpdateProductVM> UpdateAsync(int id);
        Task<bool> UpdatePostAsync(int id, UpdateProductVM update, ModelStateDictionary model);

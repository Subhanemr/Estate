...
namespace Estate.Application.Abstractions.Services
{
    public interface IBlogService
    {
        ...
        Task<ICollection<ItemBlogVM>> GetAllWhereByOrderAsync(int take, Expression<Func<Blog, bool>>? expression, Expression<Func<Blog, object>>? orderExpression, int page);
